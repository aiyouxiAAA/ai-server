...
func TestClassicDataLookupsReturnDetachedRows(t *testing.T) {
	...
	if !found || grasslandMonster["name"] != "草刺槐" || grasslandMonster["map_id"] != "210" || grasslandMonster["max_hp"] != "1530" || grasslandMonster["max_mp"] != "1034" || grasslandMonster["attack"] != "273" {
		t.Fatalf("FindMonsterByID(grassland) = %v %v, want 草刺槐 map210 HP1530 MP1034 attack273", found, grasslandMonster)
	}
